...
datatype type_expr = GENERIC | T of Word8.word
...
val bits : V8.vector = V8.fromList
                           [0wx80,0wx40,0wx20,0wx10,0wx08,0wx04,0wx02,0wx01]


fun W32_to_V8 w =
    let val conv = W8.fromInt o W32.toInt o (fn x => W32.andb (x, 0w256))
    in tabulate (4, fn i = conv (W32.>> (w, W.fromInt (i*2)))) end
